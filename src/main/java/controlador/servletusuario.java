...
public class servletusuario extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (request.getParameter("btnins") != null) {
			...
			if (request.getParameter("cedula") != "" && request.getParameter("usuario") != ""
		...
		if (request.getParameter("btncon") != null) {
			...
			if (request.getParameter("cedula") != "") {
				...
				if (recdatos != null) {
					...
					response.sendRedirect("usuario.jsp?do=" + doc + "&&us=" + email_usuario + "&&cl=" + nombre_usuario
							+ "&&ro=" + password + "&&es=" + usuario);
